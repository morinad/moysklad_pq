# Кастомный коннектор к Мойсклад для Power BI
...
1) Скачайте файл MEZ: https://github.com/morinad/moysklad_pq/raw/main/Moysklad.mez
...
4) Нажмите на кнопку "Получить данные", в поиске введите "Moysklad" и выберите коннектор Moysklad Connector.


### Полезные ссылки:
Подробная инструкция по использованию коннектора: http://directprobi.ru/blogs/integraciya-k-api-moysklad-dlya-otchetov-v-power-bi-i-excel/
